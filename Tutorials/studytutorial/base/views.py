...
def registerPage(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            user = form.save(commit=False) # return instead of saving to database
            ...
            messages.error(request, 'Error occurred while creating user')
...
def home(request):
    # get all the database model objects
    q = request.GET.get('q')
